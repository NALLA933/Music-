...
YOUTUBE_COOKIES_FILE = getenv("YOUTUBE_COOKIES_FILE", "cookies/cookie.txt")
YOUTUBE_COOKIES = getenv("YOUTUBE_COOKIES", "")

# Read cookies from file if it exists
if YOUTUBE_COOKIES_FILE and os.path.exists(YOUTUBE_COOKIES_FILE):
    try:
        with open(YOUTUBE_COOKIES_FILE, 'r') as f:
            YOUTUBE_COOKIES = f.read()
        print(f"✓ YouTube cookies loaded from {YOUTUBE_COOKIES_FILE}")
...
# Maximum limit for fetching playlist's track from youtube, spotify, spotify, apple links.
